...
import { Text, View, Dimensions, ScrollView, Button } from 'react-native';
    ...
    render() {
        return (
            <View style={{
                ...
                <ScrollView>
                    <View style={{
                        width: width - 40, height: height - 50, margin: 20, padding: 10
                    }}>
                        <Button onPress={() => this.increaseFont("plus")} title="+" color="pink" />
                        <Button onPress={() => this.increaseFont("minus")} title="-" color="pink" />
                        <Text style={{ fontSize: this.state.initialFontSize, fontWeight: 'bold', textAlign: 'justify' }}>
